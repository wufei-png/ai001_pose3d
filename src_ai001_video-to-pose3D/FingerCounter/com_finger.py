import cv2
import FingerCounter.HandTrackingModule as htm
import time

#############################
wCam, hCam = 640, 480
# #############################
# cap = cv2.VideoCapture('1.mp4')  # 若使用笔记本自带摄像头则编号为0  若使用外接摄像头 则更改为1或其他编号
...
def counter(img):
        ...
        if len(lmList) != 0:
            ...
            HandImage = cv2.imread(f'./FingerCounter/FingerImg/{count}.jpg')

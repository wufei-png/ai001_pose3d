...
from joints_detectors.Alphapose.SPPE.src.utils.eval import getPrediction, getMultiPeakPrediction
from joints_detectors.Alphapose.SPPE.src.utils.img import load_image, cropBox, im_to_torch
...
if opt.vis_fast:
    print('这个模型快啊123，此语句位于pose_3d.py的from import的模块中')
    from joints_detectors.Alphapose.fn import vis_frame_fast as vis_frame
else:
    print('这个模型慢啊')
...
class DataWriter:
            ...
            if not self.Q.empty():
                ...
                if boxes is None:
                    ...
                    if opt.matching:
                        ...
                        print('opt.matching yes')
                        print('opt.inputResH',opt.inputResH)
    ...
    def get_latest_result(self):
        # return final result
        # print('self.final_result',self.final_result)
        return self.final_result[len(self.final_result)-1]
    def len(self):
        # return queue len
        return self.Q.qsize()
